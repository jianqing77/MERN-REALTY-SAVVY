...
const navigation = [
    ...
    { name: 'Account Security', href: '#', icon: Cog6ToothIcon, current: false },
    ...
    return (
        <>
            <div>
                ...
                <div className="fixed w-72 flex flex-col">
                    {/* Sidebar component, swap this element with another sidebar if you like */}
                    <div className="flex flex-col gap-y-5 px-6 ring-1 ring-white/5">
                        <nav>
